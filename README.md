...
| ------------------------- |  -------- | -------- | -------- | -------- | -------- | -------- | 
| TransFuse[1] | 2021 | ViT + CNN / Parallel | Segmentation | Prostate Multi-modality MRIs from the Medical Segmentation Decathlon | MRI | MRIs from 32 patients, with volume shape of 20×320×3
